...
def _run_two_ranks(script: str, timeout: int = 240) -> list[str]:
...
out, params, study = autotrainer.fit(
    model, train, val,
    trials=2, epochs=2, epochs_per_trial=1,
...
class TestTwoRankGloo:
    ...
    def test_fit_produces_identical_weights_on_all_ranks(self):
        pytest.importorskip("optuna")
        r0, r1 = _run_two_ranks(_FIT_WORKER)
